...
namespace MD.FS.FAT32
{
    class Fat32
    {
        ...
        public Fat32(Stream s)
        {
            ...
            Fat = makeClusterChain(stream, BR);
        }

        private int[] makeClusterChain(Stream stream, BootRecord br)
        {
        ...
        public Node MakeNode(DirectoryEntry de)
        {
            var node = new Node()
            {
                ...
                IsDeletedFile = de.IsDeletedFile,
